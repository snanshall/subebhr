<script type="text/javascript">
    ...
    (function () {
        ...
        function task_kanban_init() {
            ...
            $current_time = time();
            $text .= '<a data-task-id="' . $v_task->task_id . '" style="word-wrap: break-word;" class="text-info" href="' . base_url() . 'admin/tasks/view_task_details/' . $v_task->task_id . '">' . $v_task->task_name . '</a>';
