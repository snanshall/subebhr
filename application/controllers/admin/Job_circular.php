...
class Job_Circular extends Admin_Controller
{
    ...
    public function save_job_posted($id = NULL)
    {
        ...
        if (!empty($created) || !empty($edited)) {
            $data = $this->job_circular_model->array_from_post(array('job_title', 'designations_id', 'vacancy_no', 'experience', 'age', 'salary_range', 'posted_date', 'description', 'last_date', 'status'));
