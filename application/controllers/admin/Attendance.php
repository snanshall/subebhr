...
//        $this->load->view('admin/_layout_main', $data);
    ...
    public function delete_request($id)
    {
        ...
        $activities = array(
            ...
            'icon' => 'fa-ticket',
            'value1' => lang('date_in') . strftime(config_item('date_format'), strtotime($clock_history->date_in)) . '  ' . lang('on') . ' ' . date('h:i A', strtotime($clock_history->clockin_edit)),
            'value2' => lang('date_in') . strftime(config_item('date_format'), strtotime($clock_history->date_out)) . '  ' . lang('on') . ' ' . date('h:i A', strtotime($clock_history->clockout_time)),
        );
// Update into tbl_project
        $this->attendance_model->_table_name = "tbl_activities"; //table name
        $this->attendance_model->_primary_key = "activities_id";
        ...
        set_message($type, $message);
        redirect('admin/attendance/timechange_request');
    }
