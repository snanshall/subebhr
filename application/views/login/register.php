...
<form method="post" action="<?= base_url() ?>login/registered_user">
    ...
    <div class="form-group has-feedback">
        ...
        <input type="email" name="company_email" required="true" class="form-control"
    ...
    <div class="form-group has-feedback">
        ...
        <select name="language" class="form-control"
                style="width: 100%">
            <?php
            $languages = $this->db->get('tbl_languages')->result();
            if (!empty($languages)) {
    ...
    <div class="form-group has-feedback">
        ...
        <input type="password" placeholder="<?= lang('password') ?>" required="true" class="form-control"
               name="password">
