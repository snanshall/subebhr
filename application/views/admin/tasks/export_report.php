    ...
    <tr>
        <td style="width: 50%">
            ...
            <?php if (!empty($task_details->billable) && $task_details->billable == 'Yes') {
                ...
                ?>
                <div class="name"><strong><?= lang('budget') ?>
            ...
            <div class="name"><strong><?= lang('created_date') ?>
                    :</strong><?= strftime(config_item('date_format'), strtotime($task_details->task_created_date)) . ' ' . lang('on') . ' ' . date('h:i A', strtotime($task_details->task_created_date)) ?>
            </div>
            ...
            foreach ($total_tasks_timer as $v_task_timer) {
                ...
                if (!empty($task_info)) {
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><?= strftime(config_item('date_format') . ' %H:%M', $v_task_timer->start_time) ?></td>
                        <td style="text-align: center"><?= strftime(config_item('date_format') . ' %H:%M', $v_task_timer->end_time) ?></td>
