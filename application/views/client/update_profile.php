...
<div class="row">
                ...
                <form role="form" id="change_password" style="display: initial"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <span id="id_error_msg"><small style="padding-left:10px;color:red;font-size:10px">Your
    ...
    <div class="col-sm-6 wrap-fpanel">
        <div class="panel panel-custom" data-collapsed="0">
            ...
            <div class="panel-body">
                <form role="form" id="change_password" action="<?php echo base_url(); ?>client/settings/set_password"
